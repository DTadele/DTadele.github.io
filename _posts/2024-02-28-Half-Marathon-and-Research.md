...
<div class="row">
    <div class="row justify-content-sm-center">
        ...
        {% include figure.html path="assets/img/Half_marathon_1.jpg" title="example image" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>

<div class="caption">
   <span class="font-weight-bold"> First half marathon medial with Knee injury at 2:20:00. Well deserved!!! </span>
</div>
